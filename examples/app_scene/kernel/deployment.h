...
#define POK_CONFIG_PARTITIONS_SCHEDULER {POK_NEEDS_SCHED_EDF,POK_SCHED_RR}
...
#define POK_CONFIG_SCHEDULING_SLOTS {200000000000, 4000000000, 1000000000, 1000000000}
#define POK_CONFIG_SCHEDULING_MAJOR_FRAME 206000000000
